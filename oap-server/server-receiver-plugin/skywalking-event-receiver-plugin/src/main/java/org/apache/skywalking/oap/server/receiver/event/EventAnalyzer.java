...
public class EventAnalyzer {
    ...
    private final EventAnalysisListenerFactoryManager factoryManager;

    private final List<EventAnalysisListener> listeners = new ArrayList<>();
    ...
    private void notifyListenerToBuild() {
        listeners.forEach(EventAnalysisListener::build);
    }
