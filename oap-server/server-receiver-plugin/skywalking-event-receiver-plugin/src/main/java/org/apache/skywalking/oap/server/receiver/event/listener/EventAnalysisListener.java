...
/**
 * {@code EventAnalysisListener} represents the callback when OAP does the event data analysis.
 */
public interface EventAnalysisListener {
    /**
    ...
    interface Factory {
        EventAnalysisListener create(final ModuleManager moduleManager);
    }
}
